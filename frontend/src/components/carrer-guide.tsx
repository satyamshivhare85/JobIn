    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border bg-blue-50 dark:bg-blue-950 mb-4">
          ...
          <span className="text-sm font-medium">AI-Powered Carrer Guidence</span>
        </div>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger className="group/button inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-primary px-8 text-primary-foreground hover:bg-primary/80">
            <Sparkles size={18} />
            Get Career Guidance
            <ArrowRight size={18} />
          </DialogTrigger>
            ...
            {!response ? (
              <>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Add your technical skill to recieve personalized carrer recomendations
                  </DialogDescription>
                </DialogHeader>
                      ...
                      {response && (
                        <div className="space-y-4">
                          {response.jobOptions.map((job, index) => (
                            ...
                            >
                              <h4 className="mb-2 text-base font-semibold">{job.title}</h4>
